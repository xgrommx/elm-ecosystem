...
| -------- | ----------------- | ------|
| [elm-lang/elm-compiler](https://github.com/elm-lang/elm-compiler) | Compiler for the Elm programming language. Elm aims to make web development more pleasant. Elm is a type inferred, functional reactive language that compiles to HTML, CSS, and JavaScript. | 2226 |
| [elm-lang/elm-lang.org](https://github.com/elm-lang/elm-lang.org) | The full source for http://elm-lang.org/, the home-page of the Elm programming language. Open sourced as a way to teach people how to write and serve Elm code. Follow the instructions in README.md to get the site setup on your own machine. | 545 |
| [evancz/elm-html](https://github.com/evancz/elm-html) | Use HTML in Elm! | 277 |
...
| [elm-lang/elm-platform](https://github.com/elm-lang/elm-platform) | Bundle of all core development tools for Elm | 246 |
| [elm-lang/core](https://github.com/elm-lang/core) | Elm's core libraries | 245 |
| [elm-native-ui/elm-native-ui](https://github.com/elm-native-ui/elm-native-ui) | WIP experiment: Building mobile apps with Elm powered by React Native. | 209 |
| [seliopou/elm-d3](https://github.com/seliopou/elm-d3) | Elm bindings for D3.js | 163 |
| [elm-lang/elm-reactor](https://github.com/elm-lang/elm-reactor) | Interactive development tool that makes it easy to develop and debug Elm programs. | 127 |
...
| [elm-lang/elm-repl](https://github.com/elm-lang/elm-repl) | A REPL for Elm | 72 |
...
| [deadfoxygrandpa/elm-test](https://github.com/deadfoxygrandpa/elm-test) | A unit testing framework for Elm | 67 |
| [elm-lang/elm-package](https://github.com/elm-lang/elm-package) | Command line tool to share Elm libraries | 67 |
...
| [rtfeldman/elm-webpack-loader](https://github.com/rtfeldman/elm-webpack-loader) | Webpack loader for the Elm programming language. | 49 |
...
| [ThomasWeiser/elmfire](https://github.com/ThomasWeiser/elmfire) | Firebase Bindings for Elm | 39 |
| [elm-lang/debug.elm-lang.org](https://github.com/elm-lang/debug.elm-lang.org) | Control time and change history. Laszlo's debugger lets you pause, rewind, and replay programs, swapping in new code to debug. | 39 |
| [elm-lang/elm-make](https://github.com/elm-lang/elm-make) | A build tool for Elm projects | 37 |
...
| [elm-lang/package.elm-lang.org](https://github.com/elm-lang/package.elm-lang.org) | website for browsing packages and exploring documentation | 32 |
...
| [twopoint718/elmchat](https://github.com/twopoint718/elmchat) | Using elm to make a simple chatroom | 29 |
...
| [NoRedInk/take-home](https://github.com/NoRedInk/take-home) | A take-home application written in Elm and only Elm | 19 |
| [jessitron/elm-sample](https://github.com/jessitron/elm-sample) | A starting point for Elm applications | 19 |
...
| [ElmCast/elm-node](https://github.com/ElmCast/elm-node) | Elm server side support | 17 |
...
| [lukewestby/builtwithelm](https://github.com/lukewestby/builtwithelm) | A list of projects and apps built with Elm. | 17 |
...
| [NoRedInk/elm-html-widgets](https://github.com/NoRedInk/elm-html-widgets) | An elm-html widget library | 12 |
...
| [vilterp/elm-diagrams](https://github.com/vilterp/elm-diagrams) | An Elm library for creating diagrams, inspired by Brent Yorgey's Diagrams library for Haskell. | 10 |
...
| [joefiorini/hi-elm](https://github.com/joefiorini/hi-elm) | null | 9 |
| [jystic/elm-font-awesome](https://github.com/jystic/elm-font-awesome) | Font Awesome vector icons as Elm HTML components | 9 |
...
| [rtfeldman/node-elm-test](https://github.com/rtfeldman/node-elm-test) | Runs elm-test suites from Node.js. Get it with npm install -g elm-test | 7 |
...
| [burabure/elm-collision](https://github.com/burabure/elm-collision) | Elm library to detect collision of geometry in coordinate space, AKA: are objects touching or overlapping? | 5 |
...
| [vilterp/elm-websockets](https://github.com/vilterp/elm-websockets) | use the HTML5 WebSockets API | 4 |
...
| [evancz/geolocation](https://github.com/evancz/geolocation) | Get location data from Elm | 4 |
