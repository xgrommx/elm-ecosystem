...
| -------- | ----------------- | ------|
| [elm-lang/elm-compiler](https://github.com/elm-lang/elm-compiler) | Compiler for the Elm programming language. Elm aims to make web development more pleasant. Elm is a type inferred, functional reactive language that compiles to HTML, CSS, and JavaScript. | 2262 |
| [elm-lang/elm-lang.org](https://github.com/elm-lang/elm-lang.org) | The full source for http://elm-lang.org/, the home-page of the Elm programming language. Open sourced as a way to teach people how to write and serve Elm code. Follow the instructions in README.md to get the site setup on your own machine. | 557 |
| [evancz/elm-html](https://github.com/evancz/elm-html) | Use HTML in Elm! | 280 |
| [rtfeldman/dreamwriter](https://github.com/rtfeldman/dreamwriter) | (NOTE! This has not been updated since Elm 0.15.1 and is not using current best practices. I plan to circle back to it in Spring 2016 and bring it up to standards.) Streamlined long-form writing software. Written in Elm. | 261 |
| [elm-lang/core](https://github.com/elm-lang/core) | Elm's core libraries | 261 |
| [elm-lang/elm-platform](https://github.com/elm-lang/elm-platform) | Bundle of all core development tools for Elm | 255 |
| [elm-native-ui/elm-native-ui](https://github.com/elm-native-ui/elm-native-ui) | WIP experiment: Building mobile apps with Elm powered by React Native. | 225 |
| [seliopou/elm-d3](https://github.com/seliopou/elm-d3) | Elm bindings for D3.js | 172 |
| [elm-lang/elm-reactor](https://github.com/elm-lang/elm-reactor) | Interactive development tool that makes it easy to develop and debug Elm programs. | 136 |
...
| [jcollard/elmtris](https://github.com/jcollard/elmtris) | A Tetris game for the web browser written in Elm | 92 |
| [deadfoxygrandpa/elm-test](https://github.com/deadfoxygrandpa/elm-test) | A unit testing framework for Elm | 75 |
| [elm-lang/elm-repl](https://github.com/elm-lang/elm-repl) | A REPL for Elm | 75 |
| [stephenbalaban/Gravity](https://github.com/stephenbalaban/Gravity) | An orbital simulation game written in Elm | 72 |
| [slawrence/vessel](https://github.com/slawrence/vessel) | A "tunnel" game written in Elm! | 71 |
| [elm-lang/elm-package](https://github.com/elm-lang/elm-package) | Command line tool to share Elm libraries | 69 |
| [evancz/first-person-elm](https://github.com/evancz/first-person-elm) | First-person navigation in a simple 3D world, written in Elm | 62 |
...
| [TheSeamau5/elm-checkerboardgrid-tutorial](https://github.com/TheSeamau5/elm-checkerboardgrid-tutorial) | Tutorial on Container Components in Elm | 55 |
| [Gizra/elm-hedley](https://github.com/Gizra/elm-hedley) | Elm web app with Headless Drupal backend | 48 |
...
| [robertjlooby/elm-koans](https://github.com/robertjlooby/elm-koans) | A set of koans for learning Elm | 45 |
| [TheSeamau5/elm-router](https://github.com/TheSeamau5/elm-router) | Easy routing in Elm | 43 |
| [elm-lang/elm-make](https://github.com/elm-lang/elm-make) | A build tool for Elm projects | 41 |
...
| [avh4/elm-format](https://github.com/avh4/elm-format) | elm-format formats Elm source code according to a standard set of rules | 39 |
...
| [mbylstra/html-to-elm](https://github.com/mbylstra/html-to-elm) | An online tool for converting HTML to elm-html. Go to  | 35 |
| [ElmCast/elm-oracle](https://github.com/ElmCast/elm-oracle) | Query for information about values in elm source files. | 34 |
| [grzegorzbalcerek/elm-by-example](https://github.com/grzegorzbalcerek/elm-by-example) | A tutorial for the Elm programming language | 34 |
| [twopoint718/elmchat](https://github.com/twopoint718/elmchat) | Using elm to make a simple chatroom | 32 |
| [NoRedInk/elm-rails](https://github.com/NoRedInk/elm-rails) | Convenience functions for using Elm with Rails. | 32 |
...
| [eeue56/servelm](https://github.com/eeue56/servelm) | Server-side Elm | 29 |
...
| [NoRedInk/take-home](https://github.com/NoRedInk/take-home) | A take-home application written in Elm and only Elm | 28 |
...
| [sonnym/node-elm-loader](https://github.com/sonnym/node-elm-loader) |  | 25 |
| [ScrambledEggsOnToast/2048-elm](https://github.com/ScrambledEggsOnToast/2048-elm) | A clone of 2048 using FRP in elm. | 24 |
| [rgrempel/elm-route-hash](https://github.com/rgrempel/elm-route-hash) | Router for single-page-apps in Elm | 24 |
| [Gizra/generator-elmlang](https://github.com/Gizra/generator-elmlang) | Yo generator for Elm | 23 |
| [elm-community/builtwithelm](https://github.com/elm-community/builtwithelm) | A list of projects and apps built with Elm. | 23 |
| [evancz/virtual-dom](https://github.com/evancz/virtual-dom) | Minimal virtual DOM system for Elm. Useful for creating libraries for HTML and SVG. | 23 |
| [rgrempel/elm-web-api](https://github.com/rgrempel/elm-web-api) | Elm bindings for various web APIs | 23 |
| [jessitron/elm-sample](https://github.com/jessitron/elm-sample) | A starting point for Elm applications | 22 |
| [mgold/elm-socketio](https://github.com/mgold/elm-socketio) | Socket.io wrapper for Elm. | 22 |
| [grzegorzbalcerek/ElmByExample](https://github.com/grzegorzbalcerek/ElmByExample) |  | 21 |
| [etaque/elm-route-parser](https://github.com/etaque/elm-route-parser) | Route parser for Elm, based on parser combinators | 21 |
| [ccorcos/elmish](https://github.com/ccorcos/elmish) | A Javascript UI library inspired by Elm | 21 |
...
| [JoeyEremondi/haskelm](https://github.com/JoeyEremondi/haskelm) | Haskell to Elm translation using Template Haskell. Contains both a library and executable. | 20 |
...
| [agrafix/elm-bridge](https://github.com/agrafix/elm-bridge) | Haskell: Derive Elm types from Haskell types | 17 |
...
| [sporto/hop](https://github.com/sporto/hop) | A router for single page applications in Elm | 17 |
...
| [zalando/elm-street-404](https://github.com/zalando/elm-street-404) | 404 Elm Street browser game | 16 |
| [TheSeamau5/elm-history](https://github.com/TheSeamau5/elm-history) | Elm bindings to HTML5 History API | 16 |
...
| [yasuyuky/elmtrn](https://github.com/yasuyuky/elmtrn) | elm + electron boiler plate | 15 |
| [NoRedInk/elm-html-widgets](https://github.com/NoRedInk/elm-html-widgets) | An elm-html widget library | 15 |
| [ThomasWeiser/todomvc-elmfire](https://github.com/ThomasWeiser/todomvc-elmfire) | TodoMVC+Firebase  in  Elm+ElmFire | 15 |
| [alexeygolev/elm-architecture-using-ramda-and-flyd](https://github.com/alexeygolev/elm-architecture-using-ramda-and-flyd) | Elm architecture implemented in javascript using ramda and flyd | 15 |
...
| [Dandandan/Easing](https://github.com/Dandandan/Easing) | Easing (animation and timing) library for Elm | 13 |
...
| [rtfeldman/node-elm-compiler](https://github.com/rtfeldman/node-elm-compiler) | A Node.js interface to the Elm compiler binaries. | 13 |
...
| [mikegehard/elm-minesweeper](https://github.com/mikegehard/elm-minesweeper) | A minesweeper game built in Elm. | 12 |
...
| [rluiten/mailcheck](https://github.com/rluiten/mailcheck) | Port to Elm of mailcheck.js, suggests domains for emails with errors. | 12 |
...
| [grzegorzbalcerek/chess-elm](https://github.com/grzegorzbalcerek/chess-elm) | The game of chess written in elm. | 12 |
| [vilterp/elm-diagrams](https://github.com/vilterp/elm-diagrams) | An Elm library for creating diagrams, inspired by Brent Yorgey's Diagrams library for Haskell. | 12 |
| [Diamond/livechat-elm](https://github.com/Diamond/livechat-elm) | The LiveChat repository, except with Elm powering the chat code | 11 |
...
| [kfish/elm-shadertoy](https://github.com/kfish/elm-shadertoy) | Shadertoy for Elm | 11 |
| [joefiorini/elm-routing-example](https://github.com/joefiorini/elm-routing-example) |  | 11 |
| [etaque/elm-transit](https://github.com/etaque/elm-transit) | An Elm lib for transition animations between pages | 10 |
...
| [Fresheyeball/elm-http-server](https://github.com/Fresheyeball/elm-http-server) | node-http as a `Signal (Request, Reponse)` | 10 |
...
| [mybuddymichael/linter-elm-make](https://github.com/mybuddymichael/linter-elm-make) | Lint your Elm files in Atom with elm-make | 8 |
| [simonh1000/elm-fullstack-starter](https://github.com/simonh1000/elm-fullstack-starter) | Elm full-stack starter (elm-compile, browser-sync, sass,...) | 8 |
...
| [lukewestby/elm-i18n](https://github.com/lukewestby/elm-i18n) | Easy i18n for Elm apps. | 7 |
...
| [anler/elm-architecture-cover](https://github.com/anler/elm-architecture-cover) | Elm architecture written (for better or worse) in pure JS. | 5 |
