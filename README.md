...
| -------- | ----------------- | ------|
| [elm-lang/elm-compiler](https://github.com/elm-lang/elm-compiler) | Compiler for the Elm programming language. Elm aims to make web development more pleasant. Elm is a type inferred, functional reactive language that compiles to HTML, CSS, and JavaScript. | 2235 |
...
| [elm-lang/core](https://github.com/elm-lang/core) | Elm's core libraries | 247 |
| [elm-native-ui/elm-native-ui](https://github.com/elm-native-ui/elm-native-ui) | WIP experiment: Building mobile apps with Elm powered by React Native. | 213 |
| [seliopou/elm-d3](https://github.com/seliopou/elm-d3) | Elm bindings for D3.js | 164 |
...
| [rtfeldman/elm-webpack-loader](https://github.com/rtfeldman/elm-webpack-loader) | Webpack loader for the Elm programming language. | 52 |
...
| [avh4/elm-format](https://github.com/avh4/elm-format) | elm-format formats Elm source code according to a standard set of rules | 33 |
...
| [NoRedInk/take-home](https://github.com/NoRedInk/take-home) | A take-home application written in Elm and only Elm | 21 |
...
| [sporto/hop](https://github.com/sporto/hop) | A router for single page applications in Elm | 10 |
